...
def load_labber_file(labber_path: str, inspect: bool = False) -> Tuple[list[Valueclass], list[Valueclass]]:
    ...
    Args:
        ...
        inspect (bool, optional): inspect data. Defaults to False.

    Returns:
        Tuple[list[Valueclass], list[Valueclass]]: parameters and results as lists of Valueclass objects.
    """
    return labber2valueclass(labber_path, inspect=inspect)


def load_json_file(json_path: str, inspect: bool = False) -> Tuple[list[Valueclass], list[Valueclass]]:
    ...
    Returns:
        Tuple[list[Valueclass], list[Valueclass]]: parameters and results as lists of Valueclass objects.
    """
    return json2valueclass(json_path, inspect=inspect)
