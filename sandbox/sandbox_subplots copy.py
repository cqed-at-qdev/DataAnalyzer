...
fig = Plotter(figsize=(14, 6)).fig

# Inherit from Plotter
plot = Plotter(subplots=(2, 2), interactive=False, fig=fig)
...
plot.plot(duration_fit, pulse_fit, label="Fit", title="Average of all with fit", ax=(1, 1))
